...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_slider__WEBPACK_IMPORTED_MODULE_4__["initSwiper"])();
    Object(_modules_slider__WEBPACK_IMPORTED_MODULE_4__["initReviewsSwiper"])();
...
/*!******************************!*\
  !*** ./js/modules/slider.js ***!
  \******************************/
/*! exports provided: initSwiper, initReviewsSwiper */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var initSwiper = function initSwiper() {
  var swiperCoachе = new Swiper('.coachеs__slider', {
    // eslint-disable-line
...
var containerVideo = document.querySelector('.promo__container-video');
var link = document.querySelector('.promo__link-video');
var promoVideo = document.querySelector('[data-promo-video]');
var buttonPlay = document.querySelector('.promo__icon');
link.removeAttribute('href');
var createIframe = function createIframe(video) {
...
buttonPlay.addEventListener('click', function () {
  if (promoVideo && containerVideo) {
    var iframeVideo = createIframe(promoVideo);
    link.remove();
    buttonPlay.remove();
